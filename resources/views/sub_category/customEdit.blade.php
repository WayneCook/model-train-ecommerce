...
@push('after_scripts')
  ...
  $(document).ready(function(){
    ...
    if ("{{$crud->entry->image}}" != "") {
      var uploadedImages = ['<img src="/images/sub_category/{{ $crud->entry->image }}" class="file-preview-image" alt="Desert" title="Desert">'];
    }
    ...
    $(".fileInput").fileinput({
      ...
      maxFileCount: 1,
        ...
        url: '/image/deleteOldSubCategoryImage', // server delete action
        key: 100,
